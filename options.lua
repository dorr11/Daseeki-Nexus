...
local function buildHelp(flow)
    ...
    mm:Hint("Right-click \226\128\148 open or close the dashboard, the same as left-click.")
    mm:Hint("Shift + Left-click \226\128\148 invite all online characters. Mass invite is never an unmodified click.")
